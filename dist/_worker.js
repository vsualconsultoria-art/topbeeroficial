var ge=Object.defineProperty;var Ft=t=>{throw TypeError(t)};var be=(t,e,o)=>e in t?ge(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o;var h=(t,e,o)=>be(t,typeof e!="symbol"?e+"":e,o),jt=(t,e,o)=>e.has(t)||Ft("Cannot "+o);var i=(t,e,o)=>(jt(t,e,"read from private field"),o?o.call(t):e.get(t)),f=(t,e,o)=>e.has(t)?Ft("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,o),m=(t,e,o,r)=>(jt(t,e,"write to private field"),r?r.call(t,o):e.set(t,o),o),b=(t,e,o)=>(jt(t,e,"access private method"),o);var Dt=(t,e,o,r)=>({set _(a){m(t,e,a,o)},get _(){return i(t,e,r)}});var Nt=(t,e,o)=>(r,a)=>{let n=-1;return s(0);async function s(d){if(d<=n)throw new Error("next() called multiple times");n=d;let c,l=!1,u;if(t[d]?(u=t[d][0][0],r.req.routeIndex=d):u=d===t.length&&a||void 0,u)try{c=await u(r,()=>s(d+1))}catch(p){if(p instanceof Error&&e)r.error=p,c=await e(p,r),l=!0;else throw p}else r.finalized===!1&&o&&(c=await o(r));return c&&(r.finalized===!1||l)&&(r.res=c),r}},ye=Symbol(),xe=async(t,e=Object.create(null))=>{const{all:o=!1,dot:r=!1}=e,n=(t instanceof oe?t.raw.headers:t.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?ve(t,{all:o,dot:r}):{}};async function ve(t,e){const o=await t.formData();return o?we(o,e):{}}function we(t,e){const o=Object.create(null);return t.forEach((r,a)=>{e.all||a.endsWith("[]")?Ee(o,a,r):o[a]=r}),e.dot&&Object.entries(o).forEach(([r,a])=>{r.includes(".")&&(Ie(o,r,a),delete o[r])}),o}var Ee=(t,e,o)=>{t[e]!==void 0?Array.isArray(t[e])?t[e].push(o):t[e]=[t[e],o]:e.endsWith("[]")?t[e]=[o]:t[e]=o},Ie=(t,e,o)=>{let r=t;const a=e.split(".");a.forEach((n,s)=>{s===a.length-1?r[n]=o:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},Xt=t=>{const e=t.split("/");return e[0]===""&&e.shift(),e},Ce=t=>{const{groups:e,path:o}=_e(t),r=Xt(o);return Re(r,e)},_e=t=>{const e=[];return t=t.replace(/\{[^}]+\}/g,(o,r)=>{const a=`@${r}`;return e.push([a,o]),a}),{groups:e,path:t}},Re=(t,e)=>{for(let o=e.length-1;o>=0;o--){const[r]=e[o];for(let a=t.length-1;a>=0;a--)if(t[a].includes(r)){t[a]=t[a].replace(r,e[o][1]);break}}return t},_t={},Pe=(t,e)=>{if(t==="*")return"*";const o=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(o){const r=`${t}#${e}`;return _t[r]||(o[2]?_t[r]=e&&e[0]!==":"&&e[0]!=="*"?[r,o[1],new RegExp(`^${o[2]}(?=/${e})`)]:[t,o[1],new RegExp(`^${o[2]}$`)]:_t[r]=[t,o[1],!0]),_t[r]}return null},qt=(t,e)=>{try{return e(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,o=>{try{return e(o)}catch{return o}})}},Te=t=>qt(t,decodeURI),Jt=t=>{const e=t.url,o=e.indexOf("/",e.indexOf(":")+4);let r=o;for(;r<e.length;r++){const a=e.charCodeAt(r);if(a===37){const n=e.indexOf("?",r),s=e.slice(o,n===-1?void 0:n);return Te(s.includes("%25")?s.replace(/%25/g,"%2525"):s)}else if(a===63)break}return e.slice(o,r)},Ae=t=>{const e=Jt(t);return e.length>1&&e.at(-1)==="/"?e.slice(0,-1):e},rt=(t,e,...o)=>(o.length&&(e=rt(e,...o)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${e==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(e==null?void 0:e[0])==="/"?e.slice(1):e}`}`),Zt=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const e=t.split("/"),o=[];let r="";return e.forEach(a=>{if(a!==""&&!/\:/.test(a))r+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){o.length===0&&r===""?o.push("/"):o.push(r);const n=a.replace("?","");r+="/"+n,o.push(r)}else r+="/"+a}),o.filter((a,n,s)=>s.indexOf(a)===n)},Lt=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?qt(t,ee):t):t,te=(t,e,o)=>{let r;if(!o&&e&&!/[%+]/.test(e)){let s=t.indexOf("?",8);if(s===-1)return;for(t.startsWith(e,s+1)||(s=t.indexOf(`&${e}`,s+1));s!==-1;){const d=t.charCodeAt(s+e.length+1);if(d===61){const c=s+e.length+2,l=t.indexOf("&",c);return Lt(t.slice(c,l===-1?void 0:l))}else if(d==38||isNaN(d))return"";s=t.indexOf(`&${e}`,s+1)}if(r=/[%+]/.test(t),!r)return}const a={};r??(r=/[%+]/.test(t));let n=t.indexOf("?",8);for(;n!==-1;){const s=t.indexOf("&",n+1);let d=t.indexOf("=",n);d>s&&s!==-1&&(d=-1);let c=t.slice(n+1,d===-1?s===-1?void 0:s:d);if(r&&(c=Lt(c)),n=s,c==="")continue;let l;d===-1?l="":(l=t.slice(d+1,s===-1?void 0:s),r&&(l=Lt(l))),o?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(l)):a[c]??(a[c]=l)}return e?a[e]:a},Be=te,ke=(t,e)=>te(t,e,!0),ee=decodeURIComponent,Ut=t=>qt(t,ee),st,T,H,re,ae,St,U,Qt,oe=(Qt=class{constructor(t,e="/",o=[[]]){f(this,H);h(this,"raw");f(this,st);f(this,T);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});f(this,U,t=>{const{bodyCache:e,raw:o}=this,r=e[t];if(r)return r;const a=Object.keys(e)[0];return a?e[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[t]())):e[t]=o[t]()});this.raw=t,this.path=e,m(this,T,o),m(this,st,{})}param(t){return t?b(this,H,re).call(this,t):b(this,H,ae).call(this)}query(t){return Be(this.url,t)}queries(t){return ke(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const e={};return this.raw.headers.forEach((o,r)=>{e[r]=o}),e}async parseBody(t){var e;return(e=this.bodyCache).parsedBody??(e.parsedBody=await xe(this,t))}json(){return i(this,U).call(this,"text").then(t=>JSON.parse(t))}text(){return i(this,U).call(this,"text")}arrayBuffer(){return i(this,U).call(this,"arrayBuffer")}blob(){return i(this,U).call(this,"blob")}formData(){return i(this,U).call(this,"formData")}addValidatedData(t,e){i(this,st)[t]=e}valid(t){return i(this,st)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[ye](){return i(this,T)}get matchedRoutes(){return i(this,T)[0].map(([[,t]])=>t)}get routePath(){return i(this,T)[0].map(([[,t]])=>t)[this.routeIndex].path}},st=new WeakMap,T=new WeakMap,H=new WeakSet,re=function(t){const e=i(this,T)[0][this.routeIndex][1][t],o=b(this,H,St).call(this,e);return o&&/\%/.test(o)?Ut(o):o},ae=function(){const t={},e=Object.keys(i(this,T)[0][this.routeIndex][1]);for(const o of e){const r=b(this,H,St).call(this,i(this,T)[0][this.routeIndex][1][o]);r!==void 0&&(t[o]=/\%/.test(r)?Ut(r):r)}return t},St=function(t){return i(this,T)[1]?i(this,T)[1][t]:t},U=new WeakMap,Qt),$e={Stringify:1},ne=async(t,e,o,r,a)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const n=t.callbacks;return n!=null&&n.length?(a?a[0]+=t:a=[t],Promise.all(n.map(d=>d({phase:e,buffer:a,context:r}))).then(d=>Promise.all(d.filter(Boolean).map(c=>ne(c,e,!1,r,a))).then(()=>a[0]))):Promise.resolve(t)},je="text/plain; charset=UTF-8",Ot=(t,e)=>({"Content-Type":t,...e}),bt,yt,L,it,O,R,xt,ct,lt,Y,vt,wt,M,at,Vt,Le=(Vt=class{constructor(t,e){f(this,M);f(this,bt);f(this,yt);h(this,"env",{});f(this,L);h(this,"finalized",!1);h(this,"error");f(this,it);f(this,O);f(this,R);f(this,xt);f(this,ct);f(this,lt);f(this,Y);f(this,vt);f(this,wt);h(this,"render",(...t)=>(i(this,ct)??m(this,ct,e=>this.html(e)),i(this,ct).call(this,...t)));h(this,"setLayout",t=>m(this,xt,t));h(this,"getLayout",()=>i(this,xt));h(this,"setRenderer",t=>{m(this,ct,t)});h(this,"header",(t,e,o)=>{this.finalized&&m(this,R,new Response(i(this,R).body,i(this,R)));const r=i(this,R)?i(this,R).headers:i(this,Y)??m(this,Y,new Headers);e===void 0?r.delete(t):o!=null&&o.append?r.append(t,e):r.set(t,e)});h(this,"status",t=>{m(this,it,t)});h(this,"set",(t,e)=>{i(this,L)??m(this,L,new Map),i(this,L).set(t,e)});h(this,"get",t=>i(this,L)?i(this,L).get(t):void 0);h(this,"newResponse",(...t)=>b(this,M,at).call(this,...t));h(this,"body",(t,e,o)=>b(this,M,at).call(this,t,e,o));h(this,"text",(t,e,o)=>!i(this,Y)&&!i(this,it)&&!e&&!o&&!this.finalized?new Response(t):b(this,M,at).call(this,t,e,Ot(je,o)));h(this,"json",(t,e,o)=>b(this,M,at).call(this,JSON.stringify(t),e,Ot("application/json",o)));h(this,"html",(t,e,o)=>{const r=a=>b(this,M,at).call(this,a,e,Ot("text/html; charset=UTF-8",o));return typeof t=="object"?ne(t,$e.Stringify,!1,{}).then(r):r(t)});h(this,"redirect",(t,e)=>{const o=String(t);return this.header("Location",/[^\x00-\xFF]/.test(o)?encodeURI(o):o),this.newResponse(null,e??302)});h(this,"notFound",()=>(i(this,lt)??m(this,lt,()=>new Response),i(this,lt).call(this,this)));m(this,bt,t),e&&(m(this,O,e.executionCtx),this.env=e.env,m(this,lt,e.notFoundHandler),m(this,wt,e.path),m(this,vt,e.matchResult))}get req(){return i(this,yt)??m(this,yt,new oe(i(this,bt),i(this,wt),i(this,vt))),i(this,yt)}get event(){if(i(this,O)&&"respondWith"in i(this,O))return i(this,O);throw Error("This context has no FetchEvent")}get executionCtx(){if(i(this,O))return i(this,O);throw Error("This context has no ExecutionContext")}get res(){return i(this,R)||m(this,R,new Response(null,{headers:i(this,Y)??m(this,Y,new Headers)}))}set res(t){if(i(this,R)&&t){t=new Response(t.body,t);for(const[e,o]of i(this,R).headers.entries())if(e!=="content-type")if(e==="set-cookie"){const r=i(this,R).headers.getSetCookie();t.headers.delete("set-cookie");for(const a of r)t.headers.append("set-cookie",a)}else t.headers.set(e,o)}m(this,R,t),this.finalized=!0}get var(){return i(this,L)?Object.fromEntries(i(this,L)):{}}},bt=new WeakMap,yt=new WeakMap,L=new WeakMap,it=new WeakMap,O=new WeakMap,R=new WeakMap,xt=new WeakMap,ct=new WeakMap,lt=new WeakMap,Y=new WeakMap,vt=new WeakMap,wt=new WeakMap,M=new WeakSet,at=function(t,e,o){const r=i(this,R)?new Headers(i(this,R).headers):i(this,Y)??new Headers;if(typeof e=="object"&&"headers"in e){const n=e.headers instanceof Headers?e.headers:new Headers(e.headers);for(const[s,d]of n)s.toLowerCase()==="set-cookie"?r.append(s,d):r.set(s,d)}if(o)for(const[n,s]of Object.entries(o))if(typeof s=="string")r.set(n,s);else{r.delete(n);for(const d of s)r.append(n,d)}const a=typeof e=="number"?e:(e==null?void 0:e.status)??i(this,it);return new Response(t,{status:a,headers:r})},Vt),w="ALL",Oe="all",Se=["get","post","put","delete","options","patch"],se="Can not add a route since the matcher is already built.",ie=class extends Error{},qe="__COMPOSED_HANDLER",He=t=>t.text("404 Not Found",404),Mt=(t,e)=>{if("getResponse"in t){const o=t.getResponse();return e.newResponse(o.body,o)}return console.error(t),e.text("Internal Server Error",500)},A,E,ce,B,G,Rt,Pt,dt,Fe=(dt=class{constructor(e={}){f(this,E);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");f(this,A,"/");h(this,"routes",[]);f(this,B,He);h(this,"errorHandler",Mt);h(this,"onError",e=>(this.errorHandler=e,this));h(this,"notFound",e=>(m(this,B,e),this));h(this,"fetch",(e,...o)=>b(this,E,Pt).call(this,e,o[1],o[0],e.method));h(this,"request",(e,o,r,a)=>e instanceof Request?this.fetch(o?new Request(e,o):e,r,a):(e=e.toString(),this.fetch(new Request(/^https?:\/\//.test(e)?e:`http://localhost${rt("/",e)}`,o),r,a)));h(this,"fire",()=>{addEventListener("fetch",e=>{e.respondWith(b(this,E,Pt).call(this,e.request,e,void 0,e.request.method))})});[...Se,Oe].forEach(n=>{this[n]=(s,...d)=>(typeof s=="string"?m(this,A,s):b(this,E,G).call(this,n,i(this,A),s),d.forEach(c=>{b(this,E,G).call(this,n,i(this,A),c)}),this)}),this.on=(n,s,...d)=>{for(const c of[s].flat()){m(this,A,c);for(const l of[n].flat())d.map(u=>{b(this,E,G).call(this,l.toUpperCase(),i(this,A),u)})}return this},this.use=(n,...s)=>(typeof n=="string"?m(this,A,n):(m(this,A,"*"),s.unshift(n)),s.forEach(d=>{b(this,E,G).call(this,w,i(this,A),d)}),this);const{strict:r,...a}=e;Object.assign(this,a),this.getPath=r??!0?e.getPath??Jt:Ae}route(e,o){const r=this.basePath(e);return o.routes.map(a=>{var s;let n;o.errorHandler===Mt?n=a.handler:(n=async(d,c)=>(await Nt([],o.errorHandler)(d,()=>a.handler(d,c))).res,n[qe]=a.handler),b(s=r,E,G).call(s,a.method,a.path,n)}),this}basePath(e){const o=b(this,E,ce).call(this);return o._basePath=rt(this._basePath,e),o}mount(e,o,r){let a,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?a=c=>c:a=r.replaceRequest));const s=n?c=>{const l=n(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};a||(a=(()=>{const c=rt(this._basePath,e),l=c==="/"?0:c.length;return u=>{const p=new URL(u.url);return p.pathname=p.pathname.slice(l)||"/",new Request(p,u)}})());const d=async(c,l)=>{const u=await o(a(c.req.raw),...s(c));if(u)return u;await l()};return b(this,E,G).call(this,w,rt(e,"*"),d),this}},A=new WeakMap,E=new WeakSet,ce=function(){const e=new dt({router:this.router,getPath:this.getPath});return e.errorHandler=this.errorHandler,m(e,B,i(this,B)),e.routes=this.routes,e},B=new WeakMap,G=function(e,o,r){e=e.toUpperCase(),o=rt(this._basePath,o);const a={basePath:this._basePath,path:o,method:e,handler:r};this.router.add(e,o,[r,a]),this.routes.push(a)},Rt=function(e,o){if(e instanceof Error)return this.errorHandler(e,o);throw e},Pt=function(e,o,r,a){if(a==="HEAD")return(async()=>new Response(null,await b(this,E,Pt).call(this,e,o,r,"GET")))();const n=this.getPath(e,{env:r}),s=this.router.match(a,n),d=new Le(e,{path:n,matchResult:s,env:r,executionCtx:o,notFoundHandler:i(this,B)});if(s[0].length===1){let l;try{l=s[0][0][0][0](d,async()=>{d.res=await i(this,B).call(this,d)})}catch(u){return b(this,E,Rt).call(this,u,d)}return l instanceof Promise?l.then(u=>u||(d.finalized?d.res:i(this,B).call(this,d))).catch(u=>b(this,E,Rt).call(this,u,d)):l??i(this,B).call(this,d)}const c=Nt(s[0],this.errorHandler,i(this,B));return(async()=>{try{const l=await c(d);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return b(this,E,Rt).call(this,l,d)}})()},dt),le=[];function De(t,e){const o=this.buildAllMatchers(),r=((a,n)=>{const s=o[a]||o[w],d=s[2][n];if(d)return d;const c=n.match(s[0]);if(!c)return[[],le];const l=c.indexOf("",1);return[s[1][l],c]});return this.match=r,r(t,e)}var At="[^/]+",ft=".*",gt="(?:|/.*)",nt=Symbol(),Ne=new Set(".\\+*[^]$()");function Ue(t,e){return t.length===1?e.length===1?t<e?-1:1:-1:e.length===1||t===ft||t===gt?1:e===ft||e===gt?-1:t===At?1:e===At?-1:t.length===e.length?t<e?-1:1:e.length-t.length}var X,J,k,et,Me=(et=class{constructor(){f(this,X);f(this,J);f(this,k,Object.create(null))}insert(e,o,r,a,n){if(e.length===0){if(i(this,X)!==void 0)throw nt;if(n)return;m(this,X,o);return}const[s,...d]=e,c=s==="*"?d.length===0?["","",ft]:["","",At]:s==="/*"?["","",gt]:s.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const u=c[1];let p=c[2]||At;if(u&&c[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw nt;if(l=i(this,k)[p],!l){if(Object.keys(i(this,k)).some(g=>g!==ft&&g!==gt))throw nt;if(n)return;l=i(this,k)[p]=new et,u!==""&&m(l,J,a.varIndex++)}!n&&u!==""&&r.push([u,i(l,J)])}else if(l=i(this,k)[s],!l){if(Object.keys(i(this,k)).some(u=>u.length>1&&u!==ft&&u!==gt))throw nt;if(n)return;l=i(this,k)[s]=new et}l.insert(d,o,r,a,n)}buildRegExpStr(){const o=Object.keys(i(this,k)).sort(Ue).map(r=>{const a=i(this,k)[r];return(typeof i(a,J)=="number"?`(${r})@${i(a,J)}`:Ne.has(r)?`\\${r}`:r)+a.buildRegExpStr()});return typeof i(this,X)=="number"&&o.unshift(`#${i(this,X)}`),o.length===0?"":o.length===1?o[0]:"(?:"+o.join("|")+")"}},X=new WeakMap,J=new WeakMap,k=new WeakMap,et),Bt,Et,Wt,ze=(Wt=class{constructor(){f(this,Bt,{varIndex:0});f(this,Et,new Me)}insert(t,e,o){const r=[],a=[];for(let s=0;;){let d=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const l=`@\\${s}`;return a[s]=[l,c],s++,d=!0,l}),!d)break}const n=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let s=a.length-1;s>=0;s--){const[d]=a[s];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(d)!==-1){n[c]=n[c].replace(d,a[s][1]);break}}return i(this,Et).insert(n,e,r,i(this,Bt),o),r}buildRegExp(){let t=i(this,Et).buildRegExpStr();if(t==="")return[/^$/,[],[]];let e=0;const o=[],r=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,s)=>n!==void 0?(o[++e]=Number(n),"$()"):(s!==void 0&&(r[Number(s)]=++e),"")),[new RegExp(`^${t}`),o,r]}},Bt=new WeakMap,Et=new WeakMap,Wt),Qe=[/^$/,[],Object.create(null)],Tt=Object.create(null);function de(t){return Tt[t]??(Tt[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(e,o)=>o?`\\${o}`:"(?:|/.*)")}$`))}function Ve(){Tt=Object.create(null)}function We(t){var l;const e=new ze,o=[];if(t.length===0)return Qe;const r=t.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,p],[g,v])=>u?1:g?-1:p.length-v.length),a=Object.create(null);for(let u=0,p=-1,g=r.length;u<g;u++){const[v,P,F]=r[u];v?a[P]=[F.map(([_])=>[_,Object.create(null)]),le]:p++;let x;try{x=e.insert(P,p,v)}catch(_){throw _===nt?new ie(P):_}v||(o[p]=F.map(([_,D])=>{const It=Object.create(null);for(D-=1;D>=0;D--){const[Ct,$]=x[D];It[Ct]=$}return[_,It]}))}const[n,s,d]=e.buildRegExp();for(let u=0,p=o.length;u<p;u++)for(let g=0,v=o[u].length;g<v;g++){const P=(l=o[u][g])==null?void 0:l[1];if(!P)continue;const F=Object.keys(P);for(let x=0,_=F.length;x<_;x++)P[F[x]]=d[P[F[x]]]}const c=[];for(const u in s)c[u]=o[s[u]];return[n,c,a]}function ot(t,e){if(t){for(const o of Object.keys(t).sort((r,a)=>a.length-r.length))if(de(o).test(e))return[...t[o]]}}var z,Q,kt,ue,Gt,Ge=(Gt=class{constructor(){f(this,kt);h(this,"name","RegExpRouter");f(this,z);f(this,Q);h(this,"match",De);m(this,z,{[w]:Object.create(null)}),m(this,Q,{[w]:Object.create(null)})}add(t,e,o){var d;const r=i(this,z),a=i(this,Q);if(!r||!a)throw new Error(se);r[t]||[r,a].forEach(c=>{c[t]=Object.create(null),Object.keys(c[w]).forEach(l=>{c[t][l]=[...c[w][l]]})}),e==="/*"&&(e="*");const n=(e.match(/\/:/g)||[]).length;if(/\*$/.test(e)){const c=de(e);t===w?Object.keys(r).forEach(l=>{var u;(u=r[l])[e]||(u[e]=ot(r[l],e)||ot(r[w],e)||[])}):(d=r[t])[e]||(d[e]=ot(r[t],e)||ot(r[w],e)||[]),Object.keys(r).forEach(l=>{(t===w||t===l)&&Object.keys(r[l]).forEach(u=>{c.test(u)&&r[l][u].push([o,n])})}),Object.keys(a).forEach(l=>{(t===w||t===l)&&Object.keys(a[l]).forEach(u=>c.test(u)&&a[l][u].push([o,n]))});return}const s=Zt(e)||[e];for(let c=0,l=s.length;c<l;c++){const u=s[c];Object.keys(a).forEach(p=>{var g;(t===w||t===p)&&((g=a[p])[u]||(g[u]=[...ot(r[p],u)||ot(r[w],u)||[]]),a[p][u].push([o,n-l+c+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(i(this,Q)).concat(Object.keys(i(this,z))).forEach(e=>{t[e]||(t[e]=b(this,kt,ue).call(this,e))}),m(this,z,m(this,Q,void 0)),Ve(),t}},z=new WeakMap,Q=new WeakMap,kt=new WeakSet,ue=function(t){const e=[];let o=t===w;return[i(this,z),i(this,Q)].forEach(r=>{const a=r[t]?Object.keys(r[t]).map(n=>[n,r[t][n]]):[];a.length!==0?(o||(o=!0),e.push(...a)):t!==w&&e.push(...Object.keys(r[w]).map(n=>[n,r[w][n]]))}),o?We(e):null},Gt),V,S,Kt,Ke=(Kt=class{constructor(t){h(this,"name","SmartRouter");f(this,V,[]);f(this,S,[]);m(this,V,t.routers)}add(t,e,o){if(!i(this,S))throw new Error(se);i(this,S).push([t,e,o])}match(t,e){if(!i(this,S))throw new Error("Fatal error");const o=i(this,V),r=i(this,S),a=o.length;let n=0,s;for(;n<a;n++){const d=o[n];try{for(let c=0,l=r.length;c<l;c++)d.add(...r[c]);s=d.match(t,e)}catch(c){if(c instanceof ie)continue;throw c}this.match=d.match.bind(d),m(this,V,[d]),m(this,S,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,s}get activeRouter(){if(i(this,S)||i(this,V).length!==1)throw new Error("No active router has been determined yet.");return i(this,V)[0]}},V=new WeakMap,S=new WeakMap,Kt),ht=Object.create(null),W,C,Z,ut,I,q,K,pt,Ye=(pt=class{constructor(e,o,r){f(this,q);f(this,W);f(this,C);f(this,Z);f(this,ut,0);f(this,I,ht);if(m(this,C,r||Object.create(null)),m(this,W,[]),e&&o){const a=Object.create(null);a[e]={handler:o,possibleKeys:[],score:0},m(this,W,[a])}m(this,Z,[])}insert(e,o,r){m(this,ut,++Dt(this,ut)._);let a=this;const n=Ce(o),s=[];for(let d=0,c=n.length;d<c;d++){const l=n[d],u=n[d+1],p=Pe(l,u),g=Array.isArray(p)?p[0]:l;if(g in i(a,C)){a=i(a,C)[g],p&&s.push(p[1]);continue}i(a,C)[g]=new pt,p&&(i(a,Z).push(p),s.push(p[1])),a=i(a,C)[g]}return i(a,W).push({[e]:{handler:r,possibleKeys:s.filter((d,c,l)=>l.indexOf(d)===c),score:i(this,ut)}}),a}search(e,o){var c;const r=[];m(this,I,ht);let n=[this];const s=Xt(o),d=[];for(let l=0,u=s.length;l<u;l++){const p=s[l],g=l===u-1,v=[];for(let P=0,F=n.length;P<F;P++){const x=n[P],_=i(x,C)[p];_&&(m(_,I,i(x,I)),g?(i(_,C)["*"]&&r.push(...b(this,q,K).call(this,i(_,C)["*"],e,i(x,I))),r.push(...b(this,q,K).call(this,_,e,i(x,I)))):v.push(_));for(let D=0,It=i(x,Z).length;D<It;D++){const Ct=i(x,Z)[D],$=i(x,I)===ht?{}:{...i(x,I)};if(Ct==="*"){const N=i(x,C)["*"];N&&(r.push(...b(this,q,K).call(this,N,e,i(x,I))),m(N,I,$),v.push(N));continue}const[he,Ht,mt]=Ct;if(!p&&!(mt instanceof RegExp))continue;const j=i(x,C)[he],fe=s.slice(l).join("/");if(mt instanceof RegExp){const N=mt.exec(fe);if(N){if($[Ht]=N[0],r.push(...b(this,q,K).call(this,j,e,i(x,I),$)),Object.keys(i(j,C)).length){m(j,I,$);const $t=((c=N[0].match(/\//))==null?void 0:c.length)??0;(d[$t]||(d[$t]=[])).push(j)}continue}}(mt===!0||mt.test(p))&&($[Ht]=p,g?(r.push(...b(this,q,K).call(this,j,e,$,i(x,I))),i(j,C)["*"]&&r.push(...b(this,q,K).call(this,i(j,C)["*"],e,$,i(x,I)))):(m(j,I,$),v.push(j)))}}n=v.concat(d.shift()??[])}return r.length>1&&r.sort((l,u)=>l.score-u.score),[r.map(({handler:l,params:u})=>[l,u])]}},W=new WeakMap,C=new WeakMap,Z=new WeakMap,ut=new WeakMap,I=new WeakMap,q=new WeakSet,K=function(e,o,r,a){const n=[];for(let s=0,d=i(e,W).length;s<d;s++){const c=i(e,W)[s],l=c[o]||c[w],u={};if(l!==void 0&&(l.params=Object.create(null),n.push(l),r!==ht||a&&a!==ht))for(let p=0,g=l.possibleKeys.length;p<g;p++){const v=l.possibleKeys[p],P=u[l.score];l.params[v]=a!=null&&a[v]&&!P?a[v]:r[v]??(a==null?void 0:a[v]),u[l.score]=!0}}return n},pt),tt,Yt,Xe=(Yt=class{constructor(){h(this,"name","TrieRouter");f(this,tt);m(this,tt,new Ye)}add(t,e,o){const r=Zt(e);if(r){for(let a=0,n=r.length;a<n;a++)i(this,tt).insert(t,r[a],o);return}i(this,tt).insert(t,e,o)}match(t,e){return i(this,tt).search(t,e)}},tt=new WeakMap,Yt),pe=class extends Fe{constructor(t={}){super(t),this.router=t.router??new Ke({routers:[new Ge,new Xe]})}},Je=t=>{const o={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...t},r=(n=>typeof n=="string"?n==="*"?()=>n:s=>n===s?s:null:typeof n=="function"?n:s=>n.includes(s)?s:null)(o.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(o.allowMethods);return async function(s,d){var u;function c(p,g){s.res.headers.set(p,g)}const l=await r(s.req.header("origin")||"",s);if(l&&c("Access-Control-Allow-Origin",l),o.credentials&&c("Access-Control-Allow-Credentials","true"),(u=o.exposeHeaders)!=null&&u.length&&c("Access-Control-Expose-Headers",o.exposeHeaders.join(",")),s.req.method==="OPTIONS"){o.origin!=="*"&&c("Vary","Origin"),o.maxAge!=null&&c("Access-Control-Max-Age",o.maxAge.toString());const p=await a(s.req.header("origin")||"",s);p.length&&c("Access-Control-Allow-Methods",p.join(","));let g=o.allowHeaders;if(!(g!=null&&g.length)){const v=s.req.header("Access-Control-Request-Headers");v&&(g=v.split(/\s*,\s*/))}return g!=null&&g.length&&(c("Access-Control-Allow-Headers",g.join(",")),s.res.headers.append("Vary","Access-Control-Request-Headers")),s.res.headers.delete("Content-Length"),s.res.headers.delete("Content-Type"),new Response(null,{headers:s.res.headers,status:204,statusText:"No Content"})}await d(),o.origin!=="*"&&s.header("Vary","Origin",{append:!0})}};const y=new pe;y.use("/api/*",Je());y.post("/api/auth/verify",async t=>{const{password:e}=await t.req.json();return t.json({success:e==="123"})});y.get("/api/products",async t=>{const{DB:e}=t.env,{results:o}=await e.prepare("SELECT * FROM products ORDER BY id DESC").all();return t.json(o)});y.get("/api/products/:id",async t=>{const{DB:e}=t.env,o=t.req.param("id"),{results:r}=await e.prepare("SELECT * FROM products WHERE id = ?").bind(o).all();return t.json(r[0]||null)});y.post("/api/products",async t=>{const{DB:e}=t.env,{name:o,price:r,brand:a,stock_quantity:n,image_url:s,cold_quantity:d,hot_quantity:c,unit_type:l,category:u}=await t.req.json(),p=await e.prepare("INSERT INTO products (name, price, brand, stock_quantity, image_url, cold_quantity, hot_quantity, unit_type, category) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)").bind(o,r,a,n||0,s||null,d||0,c||0,l||"Unidade",u||"Bebidas").run();return t.json({id:p.meta.last_row_id,success:!0})});y.put("/api/products/:id",async t=>{const{DB:e}=t.env,o=t.req.param("id"),{name:r,price:a,brand:n,stock_quantity:s,image_url:d,cold_quantity:c,hot_quantity:l,unit_type:u,category:p}=await t.req.json();return await e.prepare("UPDATE products SET name = ?, price = ?, brand = ?, stock_quantity = ?, image_url = ?, cold_quantity = ?, hot_quantity = ?, unit_type = ?, category = ? WHERE id = ?").bind(r,a,n,s,d,c,l,u,p,o).run(),t.json({success:!0})});y.delete("/api/products/:id",async t=>{const{DB:e}=t.env,o=t.req.param("id");return await e.prepare("DELETE FROM products WHERE id = ?").bind(o).run(),t.json({success:!0})});y.get("/api/customers",async t=>{const{DB:e}=t.env,{results:o}=await e.prepare("SELECT * FROM customers ORDER BY name").all();return t.json(o)});y.get("/api/customers/:id",async t=>{const{DB:e}=t.env,o=t.req.param("id"),{results:r}=await e.prepare("SELECT * FROM customers WHERE id = ?").bind(o).all();return t.json(r[0]||null)});y.post("/api/customers",async t=>{const{DB:e}=t.env,{name:o,address:r,neighborhood:a,zip_code:n,city:s,phone:d}=await t.req.json(),c=await e.prepare("INSERT INTO customers (name, address, neighborhood, zip_code, city, phone) VALUES (?, ?, ?, ?, ?, ?)").bind(o,r,a,n,s,d).run();return t.json({id:c.meta.last_row_id,success:!0})});y.put("/api/customers/:id",async t=>{const{DB:e}=t.env,o=t.req.param("id"),{name:r,address:a,neighborhood:n,zip_code:s,city:d,phone:c}=await t.req.json();return await e.prepare("UPDATE customers SET name = ?, address = ?, neighborhood = ?, zip_code = ?, city = ?, phone = ? WHERE id = ?").bind(r,a,n,s,d,c,o).run(),t.json({success:!0})});y.delete("/api/customers/:id",async t=>{const{DB:e}=t.env,o=t.req.param("id");return await e.prepare("DELETE FROM customers WHERE id = ?").bind(o).run(),t.json({success:!0})});y.post("/api/orders",async t=>{const{DB:e}=t.env,{customer_id:o,items:r,payment_method:a,total_amount:n}=await t.req.json(),d=(await e.prepare("INSERT INTO orders (customer_id, total_amount, payment_method) VALUES (?, ?, ?)").bind(o,n,a).run()).meta.last_row_id;for(const c of r)await e.prepare("INSERT INTO order_items (order_id, product_id, quantity, unit_price, total_price) VALUES (?, ?, ?, ?, ?)").bind(d,c.product_id,c.quantity,c.unit_price,c.total_price).run();return t.json({id:d,success:!0})});y.get("/api/orders/:id",async t=>{const{DB:e}=t.env,o=t.req.param("id"),{results:r}=await e.prepare("SELECT o.*, c.name as customer_name, c.phone, c.address, c.neighborhood, c.city FROM orders o JOIN customers c ON o.customer_id = c.id WHERE o.id = ?").bind(o).all();if(!r.length)return t.json(null);const a=r[0],{results:n}=await e.prepare("SELECT oi.*, p.name as product_name, p.brand FROM order_items oi JOIN products p ON oi.product_id = p.id WHERE oi.order_id = ?").bind(o).all();return t.json({...a,items:n})});y.get("/api/settings/logo",async t=>{var r;const{DB:e}=t.env,{results:o}=await e.prepare("SELECT value FROM settings WHERE key = 'logo_url'").all();return t.json({logo_url:((r=o[0])==null?void 0:r.value)||null})});y.post("/api/settings/logo",async t=>{const{DB:e}=t.env,{logo_url:o}=await t.req.json();return await e.prepare("INSERT OR REPLACE INTO settings (key, value, updated_at) VALUES ('logo_url', ?, CURRENT_TIMESTAMP)").bind(o).run(),t.json({success:!0})});y.get("/api/settings/footer-logo",async t=>{var r;const{DB:e}=t.env,{results:o}=await e.prepare("SELECT value FROM settings WHERE key = 'footer_logo_url'").all();return t.json({footer_logo_url:((r=o[0])==null?void 0:r.value)||null})});y.post("/api/settings/footer-logo",async t=>{const{DB:e}=t.env,{footer_logo_url:o}=await t.req.json();return await e.prepare("INSERT OR REPLACE INTO settings (key, value, updated_at) VALUES ('footer_logo_url', ?, CURRENT_TIMESTAMP)").bind(o).run(),t.json({success:!0})});y.get("/api/settings/branches",async t=>{var r;const{DB:e}=t.env,{results:o}=await e.prepare("SELECT value FROM settings WHERE key = 'branches'").all();return t.json({branches:((r=o[0])==null?void 0:r.value)||""})});y.post("/api/settings/branches",async t=>{const{DB:e}=t.env,{branches:o}=await t.req.json();return await e.prepare("INSERT OR REPLACE INTO settings (key, value, updated_at) VALUES ('branches', ?, CURRENT_TIMESTAMP)").bind(o).run(),t.json({success:!0})});y.post("/api/upload",async t=>{try{const{image:e,filename:o}=await t.req.json(),r=e.split(",")[1]||e,a=atob(r),n=new Uint8Array(a.length);for(let c=0;c<a.length;c++)n[c]=a.charCodeAt(c);const s=`${Date.now()}-${o}`,d=e;return t.json({success:!0,url:d})}catch(e){return console.error("Upload error:",e),t.json({success:!1,error:"Upload failed"},500)}});y.get("/",t=>t.html(`
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
